				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="${pageContext.request.contextPath}/logout"> <i class="icon-off"></i>
									退出
							</a></li>
						</ul></li>
				</ul>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="${pageContext.request.contextPath}/common/console" target="mainframe">
						...
						<c:if test="${menu.pid==0 }">
							...
							<li><a href="javascript:void(0)" target="mainframe"
								class="dropdown-toggle"> <i class="icon-desktop"></i> <span
									class="menu-text"> ${menu.menuname } </span> <b
								...
								<ul class="submenu">
									...
									<c:forEach var="child" items="${menus }">
										<!-- 判断该菜单是否是该一级菜单的子菜单 -->
										<c:if test="${child.pid==menu.menuid }">
											<li><a href="${pageContext.request.contextPath}/${child.url }" target="mainframe"> <i
													class="icon-double-angle-right"></i> ${child.menuname}
											</a></li>
										</c:if>
									</c:forEach>
								</ul></li>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="${pageContext.request.contextPath}/common/console"
