...
<body>
	...
	<form action="${pageContext.request.contextPath}/cost/updateCost" id="f1" method="post"
		...
		<div class="row">
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="costname"
							value="${cost.costname }" placeholder="请输入费用名称" />
					</div>
				</div>
			</div>
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<textarea rows="" cols="" required class="form-control" name="costdesc">${cost.costdesc }</textarea>
					</div>
				</div>
			</div>
		</div>
