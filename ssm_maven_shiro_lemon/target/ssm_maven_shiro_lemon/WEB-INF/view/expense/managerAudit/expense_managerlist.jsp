...
<form action="${pageContext.request.contextPath}/expense/managerAudit" id="f1" method="get"
      class="form-inline">
    ...
    <div class="row" style="padding: 15px;">
        <table class="table table-hover table-condensed">
            ...
            <c:forEach items="${expenseList.list}" var="expense">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/expense/beginManagerAudit/${expense.expenseid}">审批</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
        <div id="paginationDiv">
            ...
            <a href="${pageContext.request.contextPath}/expense/managerAudit?pageNum=${expenseList.navigateFirstPage}&pageSize=${expenseList.pageSize}">首页</a>
            <a href="${pageContext.request.contextPath}/expense/managerAudit?pageNum=${expenseList.prePage}&pageSize=${expenseList.pageSize}">上一页</a>
            <a href="${pageContext.request.contextPath}/expense/managerAudit?pageNum=${expenseList.nextPage}&pageSize=${expenseList.pageSize}">下一页</a>
            <a href="${pageContext.request.contextPath}/expense/managerAudit?pageNum=${expenseList.navigateLastPage}&pageSize=${expenseList.pageSize}">尾页</a>
