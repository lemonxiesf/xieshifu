...
<body>
		...
		<div class="row" style="padding: 15px;">
            ...
            <c:forEach items="${expenseList.list}" var="expense">
                <tr>
                    ...
                    <td><fmt:formatDate value="${expense.expensedate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
                    <td class="bottom">
    ...
    <div id="paginationDiv">
        ...
        <a href="${pageContext.request.contextPath}/expense/myExpenseQuery?pageNum=${expenseList.navigateFirstPage}&pageSize=${expenseList.pageSize}">首页</a>
        <a href="${pageContext.request.contextPath}/expense/myExpenseQuery?pageNum=${expenseList.prePage}&pageSize=${expenseList.pageSize}">上一页</a>
        <a href="${pageContext.request.contextPath}/expense/myExpenseQuery?pageNum=${expenseList.nextPage}&pageSize=${expenseList.pageSize}">下一页</a>
        <a href="${pageContext.request.contextPath}/expense/myExpenseQuery?pageNum=${expenseList.navigateLastPage}&pageSize=${expenseList.pageSize}">尾页</a>
