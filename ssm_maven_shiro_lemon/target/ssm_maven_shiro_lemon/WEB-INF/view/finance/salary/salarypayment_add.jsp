...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#userId').blur(function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/salary/querySalary",
                    type: "POST",
                    datatype: "json",
                    data: {
                        userid: userId
    ...
    <script type="text/javascript">
        $(function () {
            $('#salaryMonth').blur(function () {
                var salaryMonth = $('#salaryMonth').val();
                $("#userId option").remove();
                $.ajax(
                    {
                        url: "${pageContext.request.contextPath}/salary/selectNotIssue",
                        datatype: "JSON",
                        type: "POST",
                        data:{
                        ...
                        success(userList){
                            for (var user in userList){
                                ...
                                $("#userId").append("<option value='"+userList[user].userid+"'>"+userList[user].username+"</option>");
                            }
...
<form action="${pageContext.request.contextPath}/salary/addSalary" id="f1" method="post"
    ...
    <div class="row">
            ...
            <div class="form-group ">
                ...
                <div class="col-xs-3 ">
                    <input type="text" class="form-control" required
                           ...
                           onClick="WdatePicker({dateFmt:'yyyy-MM'})" placeholder="请输入发放月份"/>
                </div>
            </div>
        </div>
        <div class="col-xs-9">
            <div class="form-group ">
                ...
                <div class="col-xs-3 ">
                    <select class="form-control" required name="userid" id="userId">
                        <option >请选择</option>
            ...
            <div class="form-group ">
                ...
                <div class="col-xs-3 ">
                    <input type="text" class="form-control" readonly="readonly"
                           required name="salarybasic" id="userSalary"
                           placeholder="请输入底薪"/>
                </div>
            </div>
        </div>
        <div class="col-xs-9">
            <div class="form-group ">
                ...
                <div class="col-xs-3 ">
                    <input type="text" class="form-control" required name="salarycomm"
                           value="0" placeholder="请输入提成"/>
                </div>
            </div>
        </div>
