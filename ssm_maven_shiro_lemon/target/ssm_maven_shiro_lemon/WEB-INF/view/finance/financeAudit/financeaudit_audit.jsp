...
<body>
	...
	<form action="${pageContext.request.contextPath}/finance/endFinanceAudit" id="f1" method="post"
		...
		<h5 class="page-header alert-info"
			style="margin: 0px; padding: 10px; margin-bottom: 10px;">财务审核</h5>
					...
					<div class="col-xs-9">
						<div class="radio">
							<label> <input type="radio" checked="checked"
								name="auditstate" value="3" />财务审核通过
							</label>
						</div>
						<div class="radio">
							<label> <input type="radio" name="auditstate" value="-2" />财务审核不通过
							</label>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8">
						<textarea rows="8" class="form-control" name="auditsugg"
							placeholder="请输入审批描述" required cols="">${record.auditsugg}</textarea>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<input type="submit" value="提交审批" class="btn btn-success" /> <a
					href="${pageContext.request.contextPath}/finance/financeList" class="btn btn-warning">返回上一级</a>
			</div>
		</div>
	</form>
